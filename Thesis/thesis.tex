...
\begin{figure}[h]
    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{tabular}{llr}
            \toprule
            $i$ & \textbf{Instrument} & \textbf{Role} \\
            \midrule
            1 & Flute & Lead \\
            2 & Oboe & Rhythm \\
            3 & Clarinet & Rhythm \\
            4 & Bassoon & Foundation \\
            \bottomrule
        \end{tabular}
        \caption{Arrangement instruments and their assigned roles.}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        \includesvg[width=\textwidth]{toy-graph.svg}
        \caption{Problem graph with $n=3$, lowest-energy valid solution highlighted.}
    \end{subfigure}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{\textwidth}
        \includegraphics[width=\textwidth,page=1]{haydn-op1.pdf}
        \caption{Constructed arrangement from solution.}
    \end{subfigure}
