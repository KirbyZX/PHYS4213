...
A quantum annealer (or solver) also has many parameters that can be tuned, influencing exactly how the annealing process is carried out and significantly affecting the quality of solutions [CITE SOLVER WEBSITE]. In this study we optimise two parameters: chain strength, and anneal time per sample. (MOVE TO QA HARDWARE SECTION)
