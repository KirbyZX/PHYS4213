...
\begin{figure}
    \centering
    \small
    \includesvg[width=.75\textwidth]{haydn-lagrange.svg}
...
\begin{figure}
    \centering\small
    \includesvg[width=.75\textwidth]{compare-reads.svg}
...
\begin{figure}
    \centering\small
    \includesvg[width=.75\textwidth]{compare-entropy.svg}
    \caption{Comparison of quantum annealing (QA) with steepest descent (SD) and simulated annealing (SA) classical solvers, varying the number of reads. Quantum annealing consistently provides lower-energy solutions than steepest descent, although fails to beat simulated annealing.}
    \label{fig:entropy}
\end{figure}
...
\begin{figure}
    \centering\small
    \includesvg[width=.75\textwidth]{scaling.svg}
