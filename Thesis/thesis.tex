...
\begin{figure}
    \includegraphics{node-constraint.png}
...
\begin{figure}
    \includegraphics{edge-constraint.png}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \includegraphics[width=0.95\linewidth]{../Figures/excerpt_trim-1.png}
