...
The outlined framework was applied to two scores: Quartet No.\ 1 in B-flat major, Op.\ 1, by Joseph Haydn, and Symphony No.\ 5 in C minor, Op.\ 67, by Ludwig van Beethoven. These pieces fit into the desired scope as detailed in \cref{sec:arrangement}, whilst being different from each other in instrumentation and structure.
