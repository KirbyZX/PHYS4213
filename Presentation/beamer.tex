...
\begin{frame}{Quantum annealing}
    ...
    \note<1->{\begin{itemize}
        ...
        \item{Possible to end in ground state, but also not}
    \end{itemize}}
\end{frame}
...
\begin{frame}{Model}
    ...
    \note<1->{\begin{itemize}
        ...
        \item{Start with initial state, a superposition of all possible states}
...
\begin{frame}{Uses}
    ...
    \begin{figure}
        \centering
        \input{../Figures/quantum-annealing-analogy.pdf_tex}
