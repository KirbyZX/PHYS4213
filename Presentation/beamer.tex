    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                ...
                \caption{Distribution of 2000 solution energies for a given problem}
            \end{figure}
        \end{column}
    \end{columns}
...
\begin{frame}{QUBO parameter variation}
    \begin{figure}
        ...
        \caption{Variation of the edge weight Lagrange parameter $B$, in multiples of the maximum node weight}
    \end{figure}
...
\begin{frame}{Example solution}
    ...
    \begin{figure}
        ...
        \caption{A returned low-energy solution, node size represents weight}
    \end{figure}

    \note<1->{\begin{itemize}
        \item Example of a returned solution with low energy
        \item Nodes grouped by instrument
        \item Constraints fulfilled, no horizontal lines, each node one colour
    \end{itemize}}
\end{frame}
