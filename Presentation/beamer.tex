...
\begin{frame}{Motivations}
    ...
    \begin{itemize}[<+(1)->]
        \item Classical methods of automatic arrangement\footcite{huang_towards_2012,nakamura_statistical_2018,li_automatic_2019}
...
\begin{frame}{2.\ Create graph}
    \centering
    \includegraphics[width=0.7\textwidth]{../Figures/toy-1.png}
    \scalebox{.8}{\input{../Figures/toy_graph.pgf}}
\end{frame}
...
\begin{frame}{Phrase detection}
    \begin{figure}
        \includegraphics[width=.8\textwidth]{boundaries.pdf}
...
\begin{frame}{QUBO parameter variation}
    \begin{figure}
        \resizebox{.7\textwidth}{!}{\input{../Figures/mult.pgf}}
        \caption{Variation of with edge weight Lagrange parameter, in multiples of the maximum node weight.}
    \end{figure}
...
\begin{frame}{Optimisation}
    \begin{figure}
        \resizebox{.8\textwidth}{!}{\input{../Figures/reads.pgf}}
    \end{figure}

    \note<1->{\begin{itemize}
        \item Exponential decay fitted
...
\begin{frame}{Example solution}
    ...
    \note<1->{\begin{itemize}
        \item Nodes grouped by instrument
