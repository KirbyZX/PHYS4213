...
\lhead{L.\ Kirby}
\rhead{Arrangement of music via quantum annealing}

\def\bibsection{\section*{References}} % Defining bibsection
 
\begin{document}

\title{Arrangement of music via quantum annealing}
